...
public class MovableObjectLog : MonoBehaviour
{
    public string playerName;

    private FileStream fsPos;
    private StreamWriter swPos;

    private FileStream fsAngle;
    private StreamWriter swAngle;

    private FileStream fsGrabbed;
    private StreamWriter swGrabbed;
